...
# full pass of directry (pod5_pass)
export DIR1=$1
...
cp -r ${DIR1} ${DIR2}/
/home/minit/nanopore/software/dorado-0.3.0-linux-x64/bin/dorado download --model dna_r10.4.1_e8.2_400bps_sup@v4.2.0 --directory ${DIR2}
...
for v in `seq 1 96`
  ...
  if [ -d ${DIR2}/pod5_pass/barcode${var} ]; then

    /home/minit/nanopore/software/dorado-0.3.0-linux-x64/bin/dorado basecaller \
      dna_r10.4.1_e8.2_400bps_sup@v4.2.0 \
      ${DIR2}/pod5_pass/barcode${var}/  > ${DIR2}/out_simplex.barcode${var}.bam
    ...
    /home/minit/nanopore/software/dorado-0.3.0-linux-x64/bin/dorado duplex \
      --min-qscore 10 \
      dna_r10.4.1_e8.2_400bps_sup@v4.2.0 \
      ${DIR2}/pod5_pass/barcode${var}/  > ${DIR2}/out_duplex.q10.barcode${var}.bam
